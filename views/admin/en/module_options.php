...
$aLang = [
    ...
    'SHOP_MODULE_esyBlockOnlyBlackListed' => 'Only block User-Agents from the block list.',
    'HELP_SHOP_MODULE_esyBlockOnlyBlackListed' => 'If this option is activated, the whitelist is not taken into account.',
];
